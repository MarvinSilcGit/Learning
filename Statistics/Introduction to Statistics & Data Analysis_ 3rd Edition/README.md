...
```
   ...
   <p>Quando essas variáveis numéricas assumem valores que excluem outros valores possíveis, essa variável serão to tipo <b>discreta</b>. Porém, quando essas variáveis assumem valores dentro de um intervalo delimitado de valores, essa variável serão do tipo <b>contínua</b>.</p>
